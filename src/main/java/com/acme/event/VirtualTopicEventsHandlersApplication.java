...
public class VirtualTopicEventsHandlersApplication {

    private static final Logger LOGGER = LoggerFactory.getLogger(VirtualTopicEventsHandlersApplication.class);

    public static void main(final String[] args) {
        SpringApplication.run(VirtualTopicEventsHandlersApplication.class, args);
    }
